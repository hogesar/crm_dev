...
<div class="tab-content">	
	  ...
	  <div id="clientdetails" class="tab-pane fade in active">
          {{ Form::open(array('route' => 'client.store', 'files' => true, 'role'=>'form', 'id'=>'client_form')) }}
	  	...
	  	<fieldset>
			...
			<div class = "form-group">
				...
				<input type = "text" id = "client_website" name = "client_website" class = "form-control" />
			</div>
			
			<div class = "form-group">
				<label for = "client_phone1">Phone 1 :</label>
				<input type = "text" id = "client_phone1" name = "client_phone1" class = "form-control" />
			</div>
			...
			<div class = "form-group">
				...
				<input type = "email" id = "client_email1" name = "client_email1" class = "form-control" />
			</div>
			
			<div class = "form-group">
				<label for = "client_email2">Email 2 :</label>
				<input type = "text" id = "client_email2" name = "client_email2" class = "form-control" />
			</div>
		...
		<div class = "formSection">
	  	...
	  	<fieldset>
			...
			<div class = "form-group">
				...
				<input type = "text" id = "client_address1" name = "client_address1" class = "form-control" />
			</div>

			<div class = "form-group">
				<label for = "client_address2">Address 2 :</label>
				<input type = "text" id = "client_address2" name = "client_address2" class = "form-control" />
			</div>

			<div class = "form-group">
				<label for = "client_address3">Address 3 :</label>
				<input type = "text" id = "client_address3" name = "client_address3" class = "form-control" />
			</div>

			<div class = "form-group">
				<label for = "client_address4">Address 4 :</label>
				<input type = "text" id = "client_address4" name = "client_address4" class = "form-control" />
			</div>
			
			<div class = "form-group">
				<label for = "client_postcode">Postcode :</label>
				<input type = "text" id = "client_postcode" name = "client_postcode" class = "form-control" />
			</div>
