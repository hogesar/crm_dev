		...
		?>
			...
			<div class = "poInfo">
					<div class = "poInfoSplit">
						<ul>
							<li><span class = "poInfoLabel">Intent Date :</span> {{date("d/m/Y", strtotime($purchaseOrder->order_date))}}</li>
							<li><span class = "poInfoLabel">Payment Date :</span> </li>
					...
					<div class = "poInfoSplit">
						<ul>
							<li><span class = "poInfoLabel">To :</span> Mr Ruslan Darchiev and Mr Igor Kovac</li>
							<li><span class = "poInfoLabel">&nbsp;</span> </li>
							<li><span class = "poInfoLabel">&nbsp;</span> </li>
							<li><span class = "poInfoLabel">&nbsp;</span></li>
							<li><span class = "poInfoLabel">Destination Country :</span> </li>
							<li><span class = "poInfoLabel">Delivery Date (Est) :</span> </li>
